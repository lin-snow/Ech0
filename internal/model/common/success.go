...
const (
	...
	GET_RANDOM_ECHO_SUCCESS       = "随机获取Echo成功"
...
const (
	...
	GET_PASSKEY_SETTINGS_SUCCESS    = "获取 Passkey 设置成功！"
	UPDATE_PASSKEY_SETTINGS_SUCCESS = "更新 Passkey 设置成功！"
	GET_PASSKEY_STATUS_SUCCESS      = "获取 Passkey 状态成功"
